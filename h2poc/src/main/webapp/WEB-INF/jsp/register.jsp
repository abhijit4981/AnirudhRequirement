		...
		<form:form action="register" modelAttribute="user" method="post">
			<table>
				<tr>
					...
					<td><form:input path="mobileNumber" required="true" value="" /></td>
				</tr>
				<tr>
					<td><label>First Name</label></td>
					<td><form:input path="firstName" required="true" value="" /></td>
				</tr>
				<tr>
                					<td><label>Last Name</label></td>
                					<td><form:input path="lastName" required="true" value="" /></td>
                				</tr>
                <tr>
